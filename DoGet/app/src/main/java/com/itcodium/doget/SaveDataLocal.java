...
public class SaveDataLocal {
    ...
    public void saveTime(String value){
            ...
            this.myEditor.putString("LAST_TIME", pString);
    ...
    public String getValue(){
        ...
        Toast.makeText(GlobalClass.context,fechaultima, Toast.LENGTH_SHORT).show();
         try{
    ...
    public long  getDiffFromLastSaved(){
        ...
        try{
            lastSaved=this.myPreferences.getString("LAST_TIME","unknown");
            // Toast.makeText(GlobalClass.context,"< Last > "+ lastSaved, Toast.LENGTH_SHORT).show();
